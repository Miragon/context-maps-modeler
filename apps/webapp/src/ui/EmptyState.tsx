 ...
 * offers exactly two actions — a primary "New diagram" that dismisses the card
 * so modelling can begin on the blank canvas, and a "Show example" that loads
 * the bundled context map. Opening a file lives in the menu, not here. Clicks
 * fall through to the canvas, and the card disappears once the first element
 * exists or the user starts a new diagram.
 */
    ...
    <div className="tt-empty" role="region" aria-label="Empty canvas">
      <div className="tt-empty__card">
        <img
          ...
          aria-hidden
        />
        <h2 className="tt-empty__title">Context Maps</h2>
