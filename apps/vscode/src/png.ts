/**
 * DOM-free PNG/encoding helpers for the EMBEDDED Context Maps scene (the native JSON document).
 *
 * Used by BOTH sides:
 *  - Extension host (Node): reads `.cm.png`/`.cm.png` bytes and extracts the document JSON
...
export const EMBED_KEYWORD = "context-maps-map";
